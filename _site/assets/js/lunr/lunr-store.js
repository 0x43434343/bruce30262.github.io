var store = [{
        ...
        "excerpt":"Description: Connect here and find the flag: nc asis-ctf.ir 12435 After we connect to the server, it show us the following message: hi all, You must send a string for each level that would make the literal True send \"Sattelite\" Sattelite (¬x2 ∨ ¬x4) ∧ (¬x1 ∨ x2) ∧ (x5...","categories": ["write-ups"],
        ...
        "excerpt":"BackdoorCTF 2015 For me, this is a challenge for CTF beginners. Most of the challenges are easy to solve, although some of them require some “imagination”… In this writeup, I’ll post the solutions of all the binary challenges and the misc challenges that I solved in the CTF. Binary echo...","categories": ["write-ups"],
        ...
        "excerpt":"Category: PPC Points: 300 nc mathproblem.2015.volgactf.ru 8888 This problem remind me of HITCON CTF 2014 – 24 The server gave us 5 numbers v1, v2, v3, v4 &amp; v5, and ask us to use +, -, *, /, ( &amp; ) to do some operation with v1, v2, v3 &amp;...","categories": ["write-ups"],
        ...
        "excerpt":"Category: Pwn Points: 250 Just another pwn task. Break in! nc pwnie.2015.volgactf.ru 7777 my_little_pwnie I solve the challenge after the end of the CTF, because I think this is a great challenge for practicing format string and sprintf BOF vulnerability. Special thanks to Lays for putting the exploit on the...","categories": ["write-ups"],
        ...
        "excerpt":"Category: Programming Points: 300 In each stage send the maximun size of area that can be covered by given points as a vertex of polygon in 2D. nc 217.218.48.84 12433 mirror 1 : nc 217.218.48.84 12432 mirror 2 : nc 217.218.48.84 12434 mirror 2 : nc 217.218.48.84 12429 Took me...","categories": ["write-ups"],
        "tags": ["ASIS","CTF","PPC","Python"],
        "url": "http://0.0.0.0:4000/asis-ctf-2015-quals/",
        "teaser":null},{
        "title": "DEFCON CTF 2015 Quals -- r0pbaby",
        "excerpt":"Category: Baby’s First Points: 1 r0pbaby_542ee6516410709a1421141501f03760.quals.shallweplayaga.me:10436 64 bit ELF. No stack guard, but it has NX &amp; PIE protection. The service will give you a menu first: Welcome to an easy Return Oriented Programming challenge… Menu: 1) Get libc address 2) Get address of a libc function 3) Nom nom...","categories": ["write-ups"],
        ...
        "excerpt":"Category: Baby’s First Points: 1 mathwhiz_c951d46fed68687ad93a84e702800b7a.quals.shallweplayaga.me:21249 The challenge’s pretty simple. The service will ask you a bunch of math problems(1000 actually), all you need to do is to answer all of them and you’ll get the flag. Notice that some of the questions contains some tricky input, like “ONE +...","categories": ["write-ups"],
        "tags": ["Python","DEFCON","CTF","PPC"],
        "url": "http://0.0.0.0:4000/defcon-ctf-2015-quals-mathwhiz/",
        "teaser":null},{
        "title": "ASIS CTF 2015 Quals -- Saw this (1 & 2)",
        "excerpt":"Category: pwn Points: 100 (Saw this-1), 400 (Saw this-2) Survive and get the flag! Note: This challenge contains two flags, one of them is easier to fetch, the other is harder. The easier flag will be clearly indicated as “Flag 1”, the harder flag as “Flag 2” nc 87.107.123.3 31337...","categories": ["write-ups"],
        ...
        "excerpt":"Category: Coding Challenge Points: 1 meow catwestern_631d7907670909fc4df2defc13f2057c.quals.shallweplayaga.me 9999 Interesting challenge. First we connect to the service, it will send us the following message: ****Initial Register State**** rax=0xfcf7659c7a4ad096 rbx=0x1df0e8dfe8f70b53 rcx=0x55004165472b9655 rdx=0x1aa98e77006adf1 rsi=0x949a482579724b11 rdi=0x1e671d7b7ef9430 r8=0x3251192496cee6a6 r9=0x278d01e964b0efc8 r10=0x1c5c8cca5112ad12 r11=0x75a01cef4514d4f5 r12=0xe109fd4392125cc7 r13=0xe5e33405335ba0ff r14=0x633e16d0ec94137 r15=0xb80a585e0cd42415 ****Send Solution In The Same Format**** About to send 74...","categories": ["write-ups"],
        ...
        "excerpt":"Category: Pwnable Points: 2 Wibbly Wobbly Timey Wimey Don’t blink! wwtw_c3722e23150e1d5abbc1c248d99d718d.quals.shallweplayaga.me:2606 32 bit ELF, with Partial RELRO, stack canary found, NX &amp; PIE enabled. First we’ll have to play a game: You(^V&lt;&gt;) must find your way to the TARDIS(T) by avoiding the angels(A). Go through the exits(E) to get to...","categories": ["write-ups"],
        ...
        "excerpt":"考量到參與 AIS3 2015 pre-exam 的人幾乎都是台灣人 這個 blog 的第一篇中文 writeup 就獻給這篇了 XD 基本上就是全包這次 exam 的所有題目 有問題歡迎留言討論 MISC MISC1 沒啥特別，範例 flag AIS3{hello_world} MISC2 給了一個 facebook.zip，有密碼 老實說我最討厭這種需要解壓縮檔密碼的題目 = = 每次打 CTF 遇到這類型題目沒有一次解出來過 = = 也因此是我卡最久的一題 之後才知道說要用到一種攻擊叫做 known plaintext attack 給定一個加密過的檔案，可以利用原檔案進行攻擊解密出 key 網路上還有 tool 可以解，叫 pkcrack 因為壓縮檔裡面有張加密過的圖片 所以可以根據檔名，想辦法 google 到原圖 然後根據 pkcrack 官方網站裡面的 document...","categories": ["write-ups"],
        ...
        "excerpt":"Category: Reversing Points: 200 This challenge gave us a NES ROM. After we launch it with NES debugger FCEUX, we found out that it eventually want us to input a password with 24 characters in length . We can found that our input was stored at memory address 0x05 ~...","categories": ["write-ups"],
        "tags": ["Python","CSAW","CTF","Z3","Reversing","NES"],
        "url": "http://0.0.0.0:4000/csaw-ctf-2015-hacking-time/",
        "teaser":null},{
        "title": "CSAW CTF 2015 -- FTP & FTP2",
        "excerpt":"Category: Reversing (FTP) &amp; Exploitable (FTP2) Points: 300 (FTP) &amp; 300 (FTP2) FTP 64 bit ELF. It’s a FTP-like service, we can list all the acceptable command by sending the HELP command. Here are some important commands that we’ll need to pass the challenges: USER [username]: enter username to login...","categories": ["write-ups"],
        "tags": ["Python","CTF","CSAW","Reversing","Pwnable","Z3"],
        "url": "http://0.0.0.0:4000/csaw-ctf-2015-ftp/",
        "teaser":null},{
        "title": "CSAW CTF 2015 -- wyvern",
        "excerpt":"Category: Reversing Points: 500 Here they gave us another 64 bit ELF, which is apparently written in C++. It will ask us to input a secret, and tell us if we failed or success. The checking secret part in the program was really hard to understand what the actual f*ck...","categories": ["write-ups"],
        ...
        "excerpt":"Category: Exploitable Points: 350 I hear bots are playing ctfs now. nc 52.20.10.244 8888 Once we connect to the service, it will send us a 64 bit ELF binary. int __cdecl main(int argc, const char **argv, const char **envp) { size_t v3; // rax@1 __int16 s; // [sp+0h] [bp-80h]@1 uint16_t...","categories": ["write-ups"],
        "tags": ["Python","CSAW","CTF","PPC","Pwnable","ROP"],
        "url": "http://0.0.0.0:4000/csaw-ctf-2015-autobots/",
        "teaser":null},{
        "title": "Hack.lu CTF 2015 -- secret library",
        "excerpt":"Category: Reversing Points: 200 64 bit ELF This service is a some kind of weird library system, which has the following functions: View the book title. You’ll have to be the “head librarian” ( = admin) first. View the book content (If you know the exact book title). Convert a...","categories": ["write-ups"],
        "tags": ["Hack.lu","Reversing","CTF","Python"],
        "url": "http://0.0.0.0:4000/hacklu-ctf-2015-secret-library/",
        "teaser":null},{
        "title": "MMA 2nd CTF 2016 -- greeting",
        "excerpt":"Category: pwn Points: 150 After a long period of time without playing any CTF, I finally finished my master’s degree and have time to enjoy some CTF challenges. And then there is the Tokyo Western/MMA 2nd CTF, the first CTF I played in 2016. The challenge gave us a 32...","categories": ["write-ups"],
        ...
        "excerpt":"Category: pwn Points: 200 64 bit ELF, with FULL RELRO, NX, stack guard &amp; PIE enabled. After doing some reversing, we found that it’s a Befunge-93 program interpreter. It will first read some Befunge-93 instructions (at most 20000 characters), then interpret &amp; execute those instructions. The program will store those...","categories": ["write-ups"],
        "tags": ["Python","MMA","CTF","Pwnable"],
        "url": "http://0.0.0.0:4000/mma-2nd-ctf-2016-interpreter/",
        "teaser":null},{
        "title": "ASIS CTF Finals 2016 -- car market",
        "excerpt":"Category: pwn Points: 177 64 bit ELF, with Partial RELRO, Canary &amp; NX enabled, no PIE. libc.so was provided. The binary is a car market program. It will let us list our cars’ info, add a car, remove a car and select a car. By selecting a car, we can...","categories": ["write-ups"],
        ...
        "excerpt":"Category: pwn Points: 99 32 bit ELF, with no NX, PIE, RELRO protection. The program will first use mmap to allocate a range of memory and treat it as a shadow stack, which stores the function return addresses. In the main function the program first ask us to input our...","categories": ["write-ups"],
        "tags": ["CTF","ASIS","Python","Pwnable","shellcode","heap"],
        "url": "http://0.0.0.0:4000/869100/",
        "teaser":null},{
        "title": "HITCON CTF 2016 Quals -- Secret Holder",
        "excerpt":"Category: pwn Points: 100 I did not finish the challenge during the contest, but was able to solve it after the game. Damn if only I can fuzz some more… 64 bit ELF, with Partial RELRO, canary &amp; NX enabled, no PIE. Program allow us to: keep secret : new...","categories": ["write-ups"],
        ...
        "excerpt":"Category: Reverse Points: 250 The challenge gave us a file call rop.iseq. By checking the file header, I found that it was a binary format of Ruby’s InstructionSequence. By googling the InstructionSequence, I found that there are some new features were added into the ruby version 2.3, for example the...","categories": ["write-ups"],
        "tags": ["CTF","HITCON","ruby","Reversing"],
        "url": "http://0.0.0.0:4000/hitcon-ctf-2016-quals-rop/",
        "teaser":null},{
        "title": "HITCON CTF 2016 Quals -- Hackpad",
        "excerpt":"Category: Crypto &amp; Forensics Points: 150 I did not look at this challenge at first, until I found that many teams have already solved this one except us, so I decide to give it a try :P It first gave us a pcap file. Several of my teammates have already...","categories": ["write-ups"],
        ...
        "excerpt":"Category: Exploit Points: 300 64 bit ELF with Full RELRO, stack canary, NX enabled, No PIE. A quick run of the program: $ ./checker Hello! What is your name? NAME : 123 Do you know flag? &gt;&gt; 123 Do you know flag? &gt;&gt; yes Oh, Really?? Please tell me the...","categories": ["write-ups"],
        "tags": ["SECCON","CTF","BOF","Pwnable","Python"],
        "url": "http://0.0.0.0:4000/seccon-ctf-2016-checker/",
        "teaser":null},{
        "title": "SECCON CTF 2016 -- chat",
        "excerpt":"Category: Exploit Points: 500 64 bit ELF with Partial RELRO, stack canary &amp; NX enabled, No PIE. The program is a simple tweet-chat service: $ ./chat Simple Chat Service 1 : Sign Up 2 : Sign In 0 : Exit menu &gt; 1 name &gt; userA Success! 1 : Sign...","categories": ["write-ups"],
        ...
        "excerpt":"Category: Misc Points: 75 Just a tiny application, that lets the user write some files and compile them with pdflatex. What can possibly go wrong? nc 78.46.224.91 24242 So this is a service that allow us to create, show &amp; compile some files. create: Create a file. Valid file format...","categories": ["write-ups"],
        "tags": ["33C3","CTF","Python","pdflatext","Misc"],
        "url": "http://0.0.0.0:4000/1255893/",
        "teaser":null},{
        "title": "33C3 CTF 2016 -- The 0x90s called",
        "excerpt":"Category: pwn Points: 150 First we’ll have to go to a web page to start our challenge session. The page will show us the port (same IP address with the web page) and the ID/password. Once we connected to the remote host and login the machine, we’ll found that we’re...","categories": ["write-ups"],
        "tags": ["CTF","33C3","Pwnable","local_root"],
        "url": "http://0.0.0.0:4000/33c3-ctf-2016-the-0x90s-called/",
        "teaser":null},{
        "title": "33C3 CTF 2016 -- ESPR",
        "excerpt":"Category: pwn Points: 150 This time there’s no binary or libc.so provided, only an image looks like this: eat: sleep: +-----------------+ +----------------+ | sub rsp, 0x100 | | mov edi, 0x1 | | mov rdi, rsp | | call _sleep | | call _gets | | | | | |...","categories": ["write-ups"],
        "tags": ["33C3","CTF","Python","Pwnable","format_string"],
        "url": "http://0.0.0.0:4000/33c3-ctf-2016-espr/",
        "teaser":null},{
        "title": "33C3 CTF 2016 -- babyfengshui",
        "excerpt":"Category: pwn Points: 150 32 bit ELF, with Partial RELRO, canary &amp; NX enabled, No PIE program menu: $ ./babyfengshui 0: Add a user 1: Delete a user 2: Display a user 3: Update a user description 4: Exit Add a user: Action: 0 size of description: 50 &lt;-- max...","categories": ["write-ups"],
        "tags": ["33C3","CTF","Pwnable","heap_overflow","heap","Python"],
        "url": "http://0.0.0.0:4000/33c3-ctf-2016-babyfengshui/",
        "teaser":null},{
        "title": "33C3 CTF 2016 -- rec",
        "excerpt":"Category: pwn Points: 200 32 bit ELF, with all the protection enabled. program menu: $ ./rec Calculators are fun! 0 - Take note 1 - Read note 2 - Polish 3 - Infix 4 - Reverse Polish 5 - Sign 6 - Exit &gt; Take note: input a note Read...","categories": ["write-ups"],
        ...
        "excerpt":"Category: Potent Pwnables 64 bit ELF, Partial RELRO, NX enabled, No canary &amp; PIE. libc not provided. This C++ program will read some input from user, then store the data into the heap memory: $ ./badint SEQ #: 0 Offset: 0 Data: AAAAAAA LSF Yes/No: Yes RX PDU [0] [len=4]...","categories": ["write-ups"],
        ...
        "excerpt":"Category: Pwnable 64 bit ELF, Partial RELRO, NX enabled, No PIE, has canary. -------- BookStore -------- 1. Add Book. 2. Edit Book. 3. Delete Book. 4. Show Books. 5. Exit. As we can see we can add, edit, delete or show a book. Books are stored in a pointer array...","categories": ["write-ups"],
